...
import PostResult from '../util/PostResult';
...
function Knockout() {
    ...
    const json = {
        "equipeA": final.t1.token,
        "equipeB": final.t2.token,
        "golsEquipeA": final.g1,
        "golsEquipeB": final.g2,
        "golsPenaltyTimeA": final.penaltis ? final.penaltis.p1 : 0,
        "golsPenaltyTimeB": final.penaltis ? final.penaltis.p2 : 0,
    }
    ...
    return (
        <div className="bracket-layout">
            ...
            <button className='btnNext' onClick={() => PostResult(json)}>ENVIAR O RESULTADO</button>
        </div>
